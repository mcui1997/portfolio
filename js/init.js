...
function tm_trigger_menu(){
	...
	var list			= jQuery('.tm_header .list ul li');
...
function tm_modalbox_news(){
	...
	var button			= jQuery('.tm_news .tm_full_link, .tm_news .news_list ul li .title a');
...
function tm_my_load(){
	...
	setTimeout(function(){jQuery('.tm_all_wrap').addClass('ready');},speed+2000);
}
		...
		var mySwiper 	= new Swiper (container, {
			...
			pagination: {
				...
				renderCustom: function (swiper,current,total) {
					...
					var progressDOM	= container.find('.tm_swiper_progress');
